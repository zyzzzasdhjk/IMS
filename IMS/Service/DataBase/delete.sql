...
DROP TABLE web.UserInfo;
DROP TABLE web.User;

DROP PROCEDURE web.UserCreateTeam;
DROP PROCEDURE web.UserDeleteTeam;
DROP PROCEDURE web.UserGetTeamMembers;
DROP PROCEDURE web.CreateTask;
