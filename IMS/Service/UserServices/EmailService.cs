...
public class EmailService
{
    ...
    {
        var stmpServer = EmailServiceSetting.Host; //smtp服务器地址
        var mailAccount = EmailServiceSetting.UserName; //邮箱账号
        var pwd = EmailServiceSetting.Password; //邮箱密码（qq邮箱此处使用授权码，其他邮箱见邮箱规定使用的是邮箱密码还是授权码）
        ...
        var mailMessage = new MailMessage(mailAccount, mailTo); //实例化邮件信息实体并设置发送方和接收方
